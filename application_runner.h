...
// Publishes the |app::ApplicationRunner| service and runs applications on their
// own threads.
class ApplicationRunner final : public Application::Delegate,
                                public app::ApplicationRunner {
 public:
 ...
 private:
  ...
  std::unique_ptr<app::ApplicationContext> host_context_;
  fidl::BindingSet<app::ApplicationRunner> active_applications_bindings_;
