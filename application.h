...
class Application final : public Engine::Delegate,
 ...
 private:
  ...
  fidl::Binding<app::ApplicationController> application_controller_;
  fidl::InterfaceRequest<app::ServiceProvider> outgoing_services_request_;
  app::ServiceProviderBridge service_provider_bridge_;
  std::unique_ptr<app::ApplicationContext> application_context_;
  fidl::BindingSet<mozart::ViewProvider> shells_bindings_;
